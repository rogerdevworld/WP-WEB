        ...
        <div className="p-6 space-y-6 bg-gradient-to-b from-white/5 to-transparent flex-1 flex flex-col">
          <div className="flex justify-between items-start gap-4">
            ...
            <button 
              ...
              className="p-2 text-gray-500 hover:text-primary transition-all bg-white/5 rounded-lg border border-white/10 hover:bg-primary/10"
            >
              <Info size={16} />
            </button>
          </div>
          
          <div className="bg-black/40 p-4 border border-white/5 rounded-xl group-hover:border-primary/20 transition-all flex items-center justify-between divide-x divide-white/10">
             <div className="flex-1 text-center px-2">
                <div className="text-[8px] font-mono text-gray-500 uppercase tracking-widest mb-1">Energy</div>
                <div className="text-lg font-display font-bold text-white">{kcal}<span className="text-[8px] ml-1 opacity-50 text-gray-400">K</span></div>
             </div>
             <div className="flex-1 text-center px-2">
                <div className="text-[8px] font-mono text-gray-500 uppercase tracking-widest mb-1">Protein</div>
                <div className="text-lg font-display font-bold text-primary">{protein}<span className="text-[8px] ml-1 opacity-50 text-primary/50">G</span></div>
             </div>
             <div className="flex-1 text-center px-2">
                <div className="text-[8px] font-mono text-gray-500 uppercase tracking-widest mb-1">Carbs</div>
                <div className="text-lg font-display font-bold text-white">{Math.round((meal.carbs || 30) * sizeMultiplier)}<span className="text-[8px] ml-1 opacity-50 text-gray-400">G</span></div>
             </div>
          </div>
